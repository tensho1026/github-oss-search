...
| GET/PUT `/api/account/issue-claims`                          | List or idempotently add account-owned contribution tasks              | 200 total; GET supports page size at most 50 and archive filter |
