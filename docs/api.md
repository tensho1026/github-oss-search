...
| GET `/api/github/users/{username}/profile-analysis`      | Technology, calendar, portfolio, OSS Journey, proficiency     | One snapshot; 20 repositories/PRs; at most 54 weeks        |
