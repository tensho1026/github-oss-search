...
| GET `/api/github/users/{username}/profile-analysis`      | Technology, calendar, OSS activity, portfolio, proficiency    | One GraphQL snapshot; 20 repositories/PRs; at most 54 weeks |
